...
namespace PI.pekara_bazaDataSetTableAdapters {
...
SELECT ID, datum, dodatniOpis, poslovniPartnerID, osobaID, tipDokumentaID FROM dokument WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PI.Properties.Settings.Default.pekara_bazaConnectionString;
        }
...
SELECT ID, ime, username, lozinka, brojtelefona, email FROM osoba WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        ID, ime, username, lozinka, brojtelefona, email\r\nFROM            os" +
        ...
        public virtual int FillByUsername(pekara_bazaDataSet.osobaDataTable dataTable, string username) {
        ...
        public virtual pekara_bazaDataSet.osobaDataTable GetDataByUsername(string username) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
